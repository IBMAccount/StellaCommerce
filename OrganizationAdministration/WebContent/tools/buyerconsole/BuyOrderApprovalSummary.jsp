	...
	public String getOrderLevelMenuAdjustment(OrderDataBean tmpOrderBean, Integer storeId)
	{
		...
		try {
			...
			if (getAdjustment != null) {
				...
				getAdjustment.setCommandContext(tmpOrderBean.getCommandContext());
...
Integer ordStoreId = orderBean.getStoreEntityIdInEJBType();
if(ordStoreId != null){
	if(storeId == null || storeId.compareTo(ordStoreId) != 0){
		CommandContext tmpCommandContext = (CommandContext)orderBean.getCommandContext().clone();
		tmpCommandContext.setStoreId(ordStoreId);
		orderBean.setCommandContext(tmpCommandContext);
		storeId = ordStoreId;
	}
}
