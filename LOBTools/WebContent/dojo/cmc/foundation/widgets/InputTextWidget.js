	...
	return declare(ComponentWidget, {
			...
			if (!this.domNode) {
				...
				this.own(
					on(this.domNode, "textarea:input", function() {
						...
						widget.component.setVariable("text", widget.getText());
		...
		createInputDiv: function(type){
			if (type === 'password'){
				...
				this.inputTextNode = domConstruct.toDom("<textarea style=\"resize:none; border-width: 0; position: absolute; background-image: none; background-color: transparent; color: #464646; outline: none; width: 100%; height: 100%; overflow: hidden; font: inherit; font-family: Helvetica,Arial,sans-serif; white-space:pre-wrap; word-wrap:break-word; word-spacing: 0px\" tabindex=\"-1\"/>");
				this.inputTextHighlighterNode = domConstruct.toDom("<div style=\"border-width: 0; position: absolute; background-image: none; background-color: transparent; color: transparent; outline: none; width: 100%; overflow: hidden; font: inherit; font-family: Helvetica,Arial,sans-serif; white-space:pre-wrap; word-wrap:break-word; word-spacing: 0px; padding: 1px;\" tabindex=\"-1\"/>");
		...
		setHighlighterPosition: function(){
			if (this.inputTextHighlighterNode){
				...
				var w = this.inputTextNode.clientWidth - 6;
				var l = this.inputTextHighlighterNode.dir == "rtl" ? 4 : 0;
