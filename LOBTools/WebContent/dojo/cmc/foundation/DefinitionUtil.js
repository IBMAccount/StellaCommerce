...
define([
	...
	return new declare(null, {
		declareModuleClass: function(classModule) {
			...
			if (typeof(baseClass) == "undefined") {
				...
				if (props.variables && inheritedVariables) {
					...
					for (var variableName in inheritedVariables) {
						if (typeof variables[variableName] == "undefined") {
							variables[variableName] = inheritedVariables[variableName];
						}
					}
				}
		...
		createDefinitionInstance: function(definition, parent, initArgs) {
			var variables = {};
			var ignoreBaseDefinition = false;
			if (definition.definitionClass.Class.prototype.variables && definition.definitionClass.Class.prototype.variables.ignoreBaseDefinition) {
				ignoreBaseDefinition = definition.definitionClass.Class.prototype.variables.ignoreBaseDefinition.value;
			}
