...
define([
	...
	"dojo/json",
	"exports"
], function(declare, Node, KeyUtil, EventUtil, MouseUtil, ComponentWidget, RootComponent, ImageRegistry, AxisLayout, domStyle, domGeometry, json, exports) {
	exports.Class = declare(Node.Class, {
		...
		constructor: function(parent, args) {
			...
			if (typeof this.width != "undefined" || (this.initPendingVariables && this.initPendingVariables.width)) {
				this.hasSetWidth = true;
			}
			if (typeof this.height != "undefined" || (this.initPendingVariables && this.initPendingVariables.height)) {
			...
			if (this.imageSet && ImageRegistry[this.imageSet]) {
				...
				if (imageIndex >= 0) {
					...
					if (cmcConfig.serviceContextRoot) {
						newSource = cmcConfig.serviceContextRoot + image.uri;
					}
					else {
						newSource = "/lobtools" + image.uri;
					}
