			...
			if (xml != null && xml != "") {
				try {
					...
					if (Logger.Singleton.enabled) {
						Logger.Singleton.log("com.ibm.commerce.lobtools.foundation.service", "SEVERE", "cmc/foundation/XMLUtil", "parseXML", "parse XML failed, exception thrown: " + e.toString() + "; XML: " + xml);
					}
				}
			}
			return rs;
		...
		innerXML: function(node){
			...
			if (node != null){
				try {
					...
					if (Logger.Singleton.enabled) {
						Logger.Singleton.log("com.ibm.commerce.lobtools.foundation.service", "SEVERE", "cmc/foundation/XMLUtil", "innerXML", "get inner XML failed, exception thrown: " + e.toString() + "; Node: " + node);
					}					
				}
			}
			return textValue;
