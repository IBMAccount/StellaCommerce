 ...
 */
CKEDITOR.plugins.setLang( 'ibmuploadimage', 'pt-br', {
	...
	infoTab	: "Propriedades de Imagem",
	linkTab	: "Link",
	...
	ibm : 
	{
        ...
        imageLinkLabel : "Inclua um link que será aberto quando a imagem for clicada.",
		fileUpload : "Selecionar um arquivo de imagem do seu computador:",
        browseFile : "Escolher Arquivo",
        noFileChosen : "Nenhum arquivo escolhido",
        notImageFile: "Selecione um arquivo de imagem.",
        fileUploadTimeout : "A inserção da imagem levou muito tempo e a ação atingiu o tempo limite. Tente novamente ou cancele.",
	serverUnreachable : "O servidor está atualmente inatingível. Entre em contato com o administrador do sistema e tente novamente mais tarde.",
        linkLabel:"Link:",
        imageSize: "A imagem é muito grande. Selecione outra imagem ou cancele.",
        inserting: "Inserindo...",
        enableActiveX: "Certifique-se de que o ActiveX esteja ativado para o Internet Explorer.",
        file: "Arquivo"
	}
});
