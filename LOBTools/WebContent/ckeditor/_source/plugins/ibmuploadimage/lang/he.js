 ...
 */
CKEDITOR.plugins.setLang( 'ibmuploadimage', 'he', {
	...
	ibm : 
	{
        insertButtonLabel : "הוספה",
        insertButtonTitle : "הוספת תמונה",
		previewText : "התמליל יגלוש מסביב לתמונה שאתם מוסיפים, כמו בדוגמה זו.",
        imageLinkLabel : "הוסיפו קישור שייפתח עם הלחיצה על התמונה.",
		fileUpload : "בחרו קובץ תמונה מהמחשב שלכם:",
        browseFile : "בחירת קובץ",
        noFileChosen : "לא נבחר קובץ",
        notImageFile: "נא לבחור קובץ תמונה.",
        fileUploadTimeout : "הוספת התמונה נמשכה זמן רב מדי והפעולה חרגה ממגבלת הזמן. נסו שוב או בטלו.",
	serverUnreachable : "השרת אינו נגיש כרגע.  פנו למנהלן המערכת ונסו שוב מאוחר יותר.‏",
        linkLabel:"קישור:",
        imageSize: "התמונה גדולה מדי. בחרו תמונה אחרת או בטלו.",
        inserting: "הוספה...‏",
        enableActiveX: "ודאו כי  ActiveX מופעל עבור Internet Explorer.‏ ",
        file: "קובץ"
	}
});
