 ...
 */
CKEDITOR.plugins.setLang( 'ibmuploadimage', 'de', {
	...
	ibm : 
	{
        ...
        insertButtonTitle : "Grafik einfügen",
		previewText : "Der Textfluss um die hinzuzufügende Grafik sieht wie in diesem Beispiel aus.",
        imageLinkLabel : "Fügen Sie einen Link hinzu, der beim Klicken auf das Bild geöffnet wird. ",
		fileUpload : "Wählen Sie eine Grafikdatei aus Ihrem Computer aus:",
        browseFile : "Datei auswählen",
        noFileChosen : "Keine Datei ausgewählt",
        notImageFile: "Wählen Sie eine Bilddatei aus. ",
        fileUploadTimeout : "Das Einfügen des Bildes hat zu lange gedauert und das zulässige Zeitlimit für die Aktion wurde überschritten. Versuchen Sie es erneut oder brechen Sie den Vorgang ab.",
	serverUnreachable : "Der Server ist derzeit nicht erreichbar. Wenden Sie sich an den zuständigen Systemadministrator und versuchen Sie es später erneut. ",
        linkLabel:"Link:",
        imageSize: "Das Bild ist zu groß. Wählen Sie ein anderes Bild aus oder brechen Sie den Vorgang ab. ",
        inserting: "Einfügen... ",
        enableActiveX: "Stellen Sie sicher, dass ActiveX für Internet Explorer aktiviert ist. ",
        file: "Datei "
	}
});
