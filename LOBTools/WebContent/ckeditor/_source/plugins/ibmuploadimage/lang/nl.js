 ...
 */
CKEDITOR.plugins.setLang( 'ibmuploadimage', 'nl', {
	...
	infoTab	: "Afbeeldingseigenschappen",
	linkTab	: "Link",
	...
	ibm : 
	{
        insertButtonLabel : "Invoegen",
        insertButtonTitle : "Afbeelding invoegen",
		previewText : "Tekst wordt rondom de door u toegevoegde afbeelding weergegeven, zoals in dit voorbeeld.",
        imageLinkLabel : "Voeg een link toe die wordt geopend wanneer op de afbeelding wordt geklikt.",
		fileUpload : "Afbeelding selecteren op de computer",
        browseFile : "Bestand kiezen",
        noFileChosen : "Geen bestand gekozen",
        notImageFile: "Selecteer een afbeeldingsbestand.",
        fileUploadTimeout : "Er is een timeout opgetreden bij het invoegen van de afbeelding. Probeer het opnieuw of annuleer.",
	serverUnreachable : "De server is niet bereikbaar. Neem contact op met de systeembeheerder en probeer het later opnieuw.",
        linkLabel:"Link:",
        imageSize: "De afbeelding is te groot. Selecteer een andere afbeelding of annuleer.",
        inserting: "Bezig met invoegen",
        enableActiveX: "Zorg dat ActiveX is ingeschakeld voor Internet Explorer.",
        file: "Bestand"
	}
});
