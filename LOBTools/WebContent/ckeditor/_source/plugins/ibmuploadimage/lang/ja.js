 ...
 */
CKEDITOR.plugins.setLang( 'ibmuploadimage', 'ja', {
	...
	ibm : 
	{
        ...
        insertButtonTitle : "イメージの挿入",
		previewText : "この例に示すように、テキストは追加するイメージの周囲に配置されます。",
        imageLinkLabel : "イメージがクリックされたときに開くリンクを追加します。",
		fileUpload : "コンピューターからイメージ・ファイルを選択:",
        browseFile : "ファイルの選択",
        noFileChosen : "ファイルが選択されていません",
        notImageFile: "イメージ・ファイルを選択してください。",
        fileUploadTimeout : "イメージの挿入にかかった時間が長すぎたため、アクションがタイムアウトになりました。 再試行するか、キャンセルします。",
	serverUnreachable : "現在サーバーには到達できません。システム管理者に問い合わせて、操作を再試行してください。",
        linkLabel:"リンク:",
        imageSize: "イメージが大きすぎます。 別のイメージを選択するか、キャンセルします。",
        inserting: "挿入中...",
        enableActiveX: "ActiveX が Internet Explorer に対応可能になっているかを確認してください。",
        file: "ファイル"
	}
});
