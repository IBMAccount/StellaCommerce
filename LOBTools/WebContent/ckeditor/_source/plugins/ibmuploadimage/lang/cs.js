 ...
 */
CKEDITOR.plugins.setLang( 'ibmuploadimage', 'cs', {
	...
	ibm : 
	{
        insertButtonLabel : "Vložit",
        insertButtonTitle : "Vložit obrázek",
		previewText : "Text bude obtékat přidaný obrázek jako v tomto příkladu.",
        imageLinkLabel : "Přidejte odkaz, který se otevře po klepnutí na obrázek.",
		fileUpload : "Vybrat soubor obrázku v počítači:",
        browseFile : "Zvolit soubor",
        noFileChosen : "Nyní zvolen žádný soubor.",
        notImageFile: "Vyberte soubor obrázku.",
        fileUploadTimeout : "Vkládání obrázku trvalo příliš dlouho a časový limit akce vypršel. Zkuste operaci zopakovat nebo ji zrušte.",
	serverUnreachable : "Server je aktuálně nedostupný. Kontaktujte administrátora systému a operaci zopakujte později.",
        linkLabel:"Odkaz:",
        imageSize: "Obrázek je příliš velký. Vyberte jiný obrázek nebo operaci zrušte.",
        inserting: "Probíhá vkládání...",
        enableActiveX: "Ověřte, že je pro prohlížeč Internet Explorer povolena technologie ActiveX. ",
        file: "Soubor"
	}
});
