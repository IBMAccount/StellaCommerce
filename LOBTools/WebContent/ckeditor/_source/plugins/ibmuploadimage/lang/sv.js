 ...
 */
CKEDITOR.plugins.setLang( 'ibmuploadimage', 'sv', {
	...
	ibm : 
	{
        ...
        insertButtonTitle : "Infoga bild",
		previewText : "Texten flödas runt den bilden du lägger till som i exemplet.",
        imageLinkLabel : "Lägg till en länk som öppnas när någon klickar på bilden.",
		fileUpload : "Välj en bild på datorn:",
        browseFile : "Välj fil",
        noFileChosen : "Ingen fil valdes",
        notImageFile: "Du måste välja en bildfil.",
        fileUploadTimeout : "Infogningen av bilden tog för lång tid och tidsgränsen uppnåddes. Försök igen eller avbryt.",
	serverUnreachable : "Servern är inte tillgänglig. Kontakta systemadministratören och försök igen senare. ",
        linkLabel:"Länk:",
        imageSize: "Bilden är för stor. Välj en annan bild eller avbryt.",
        inserting: "Infogar...",
        enableActiveX: "Kontrollera att ActiveX är aktiverat för Internet Explorer.",
        file: "Fil"
	}
});
