 ...
 */
CKEDITOR.plugins.setLang( 'ibmuploadimage', 'it', {
	...
	ibm : 
	{
        insertButtonLabel : "Inserisci",
        insertButtonTitle : "Inserisci immagine",
		previewText : "Il testo verrà posizionato attorno all'immagine che viene aggiunta, come in questo esempio.",
        imageLinkLabel : "Aggiungere un link che verrà aperto quando viene selezionata l'immagine.",
		fileUpload : "Selezionare un file di immagine dal computer:",
        browseFile : "Scegli file",
        noFileChosen : "Nessun file scelto",
        notImageFile: "Selezionare un file di immagine.",
        fileUploadTimeout : "L'inserimento dell'immagine ha richiesto troppo tempo e l'azione è scaduta. Provare di nuovo o annullare l'operazione.",
	serverUnreachable : "Il server non è al momento raggiungibile. Contattare l'amministratore di sistema o riprovare più tardi. ",
        linkLabel:"Collegamento:",
        imageSize: "L'immagine è troppo grande. Selezionare un'altra immagine o annullare l'operazione.",
        inserting: "Inserimento in corso...",
        enableActiveX: "Assicurarsi che ActiveX sia abilitato per Internet Explorer.",
        file: "File"
	}
});
