 ...
 */
CKEDITOR.plugins.setLang( 'ibmuploadimage', 'sk', {
	...
	ibm : 
	{
        ...
        insertButtonTitle : "Vložiť obrázok",
		previewText : "Text bude tiecť okolo pridávaného obrázka ako v tomto príklade.",
        imageLinkLabel : "Pridajte odkaz, ktorý sa otvorí pri kliknutí na obrázok.",
		fileUpload : "Vyberte obrazový súbor z počítača:",
        browseFile : "Vybrať súbor",
        noFileChosen : "Nie je vybratý žiadny súbor",
        notImageFile: "Vyberte obrazový súbor.",
        fileUploadTimeout : "Vkladanie obrázka trvalo pridlho a uplynul časový limit akcie. Skúste to znova alebo zrušte akciu.",
	serverUnreachable : "Server je aktuálne nedosiahnuteľný. Kontaktujte svojho administrátora systému a skúste to znova neskôr.",
        linkLabel:"Odkaz:",
        imageSize: "Obrázok je priveľký. Vyberte iný obrázok alebo zrušte akciu.",
        inserting: "Vkladá sa...",
        enableActiveX: "Zaistite, aby bola povolená technológia ActiveX pre prehliadač Internet Explorer.",
        file: "Súbor"
	}
});
