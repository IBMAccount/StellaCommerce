 ...
 */
CKEDITOR.plugins.setLang( 'ibmuploadimage', 'pl', {
	...
	ibm : 
	{
        insertButtonLabel : "Wstaw",
        insertButtonTitle : "Wstaw obraz",
		previewText : "Tekst będzie opływał dodawany obraz tak jak w tym przykładzie.",
        imageLinkLabel : "Dodaj odsyłacz, który zostanie otwarty po kliknięciu tego obrazu.",
		fileUpload : "Wybierz plik graficzny na komputerze:",
        browseFile : "Wybierz plik",
        noFileChosen : "Nie wybrano żadnego pliku",
        notImageFile: "Wybierz plik graficzny.",
        fileUploadTimeout : "Wstawianie obrazu trwało zbyt długo i działanie przekroczyło limit czasu. Spróbuj ponownie lub anuluj.",
	serverUnreachable : "Serwer jest obecnie nieosiągalny. Skontaktuj się z administratorem systemu i spróbuj ponownie później.",
        linkLabel:"Odsyłacz:",
        imageSize: "Obraz jest zbyt duży. Wybierz inny obraz lub anuluj.",
        inserting: "Wstawianie...",
        enableActiveX: "Upewnij się, że w przeglądarce Internet Explorer włączono obsługę elementów ActiveX.",
        file: "Plik"
	}
});
