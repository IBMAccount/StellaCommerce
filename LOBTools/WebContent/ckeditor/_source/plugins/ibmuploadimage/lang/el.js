 ...
 */
CKEDITOR.plugins.setLang( 'ibmuploadimage', 'el', {
	...
	ibm : 
	{
        insertButtonLabel : "Εισαγωγή",
        insertButtonTitle : "Εισαγωγή εικόνας",
		previewText : "Το κείμενο θα τοποθετηθεί γύρω από την εικόνα που προσθέτετε, όπως φαίνεται σε αυτό το παράδειγμα.",
        imageLinkLabel : "Προσθέστε μια διασύνδεση που θα ενεργοποιηθεί όταν ο χρήστης πατήσει στην εικόνα.",
		fileUpload : "Επιλέξτε ένα αρχείο εικόνας από τον υπολογιστή σας:",
        browseFile : "Επιλογή αρχείου",
        noFileChosen : "Δεν επιλέχθηκε αρχείο",
        notImageFile: "Επιλέξτε ένα αρχείο εικόνας.",
        fileUploadTimeout : "Η εισαγωγή της εικόνας ήταν πολύ χρονοβόρα και η προθεσμία της ενέργειας έληξε. Προσπαθήστε ξανά ή ακυρώστε.",
	serverUnreachable : "Δεν είναι δυνατή η επικοινωνία με τον εξυπηρετητή. Επικοινωνήστε με το διαχειριστή του συστήματος και προσπαθήστε ξανά αργότερα.",
        linkLabel:"Διασύνδεση:",
        imageSize: "Η εικόνα είναι πολύ μεγάλη. Επιλέξτε άλλη εικόνα ή ακυρώστε.",
        inserting: "Εισαγωγή...",
        enableActiveX: "Βεβαιωθείτε ότι έχει ενεργοποιηθεί το ActiveX για το Internet Explorer.",
        file: "Αρχείο"
	}
});
