...
CKEDITOR.plugins.setLang( 'link', 'pt-br', {
	...
	anchor: {
		...
		ibm :
		{
			description	: "Digite um nome de favorito descritivo, como 'Seção 1.2'. Depois de inserir o favorito, clique no ícone 'Link' ou 'Link do Documento' para vincular a ele."
		}
	},
