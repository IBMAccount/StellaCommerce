...
CKEDITOR.plugins.setLang( 'link', 'ro', {
	...
	anchor: {
		...
		ibm :
		{
			description	: "Tastaţi un nume semn de carte descriptiv, cum ar fi 'Secţiune 1.2'. După inserarea semnului de carte, faceţi clic fie pe pictograma 'Legătură', fie pe 'Legătură semn de carte document' pentru legarea la el."
		}
	},
