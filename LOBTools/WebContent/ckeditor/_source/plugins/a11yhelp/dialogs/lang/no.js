	...
	[
			...
			[
				{
					...
					legend: "Trykk på ${toolbarFocus} for å gå til verktøylinjen. " +
...

				{
					...
					legend:
						"Trykk på TAB for å navigere til neste dialogbokselement i en dialogboks, trykk på SKIFT + TAB for å gå til forrige dialogbokselement, trykk på ENTER for å sende dialogboksen, og trykk på ESC for å lukke dialogboksen. " +
						"Når en dialogboks ha flere kategorier, kan kategorilisten nås enten med ALT+F10 eller med TAB som en del av dialogboksens tabulatortastrekkefølge. " +
						"Når kategorilisten er i fokus, går du til neste og forrige kategori med henholdsvis HØYREPIL og VENSTREPIL."
				},
		...
		},
		{
			...
			[
				...
				{
					name: ' Permanent penn',
					legend: 'Trykk på ${ibmpermanentpen} (Alt+Cmd+T på MAC) inne i redigeringsprogrammet for å aktivere/deaktivere den permanente pennen.'
				},
				{
