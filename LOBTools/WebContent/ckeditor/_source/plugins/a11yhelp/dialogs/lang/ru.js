	...
	[
			...
			[
				{
					...
					legend: "Нажмите ${toolbarFocus} для перехода в панель инструментов. " +
...

				{
					name: "Окно редактора",
					legend:
						"В открытом окне нажмите TAB для перехода к следующему элементу, SHIFT+TAB для перехода к предыдущему элементу, ENTER для отправки данных или ESC для закрытия окна. " +
						"Если окно содержит несколько вкладок, то список вкладок можно просмотреть с помощью комбинации клавиш ALT+F10 или с помощью клавиши TAB при переключении между вкладками. " +
						"В списке вкладок для перемещения к следующей или предыдущей вкладке нажмите клавишу со стрелкой вправо или влево. "
				},
		...
		},
		{
			...
			[
				...
				{
					name: ' Постоянное перо',
					legend: 'Для активации/деактивации постоянного пера в редакторе нажмите ${ibmpermanentpen} (или Alt+Cmd+T на MAC).'
				},
				{
