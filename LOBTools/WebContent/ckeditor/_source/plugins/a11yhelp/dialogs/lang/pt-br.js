			...
			[
				{
					...
					legend: "Pressione ${toolbarFocus} para navegar para a barra de ferramentas. " +
						"Mova para o grupo de barra de ferramentas seguinte e anterior com TAB e SHIFT+TAB. " +
...

				{
					...
					legend:
						"Dentro de um diálogo, pressione TAB para navegar para o próximo elemento do diálogo, pressione SHIFT+TAB para mover para o elemento do diálogo anterior, pressione ENTER para enviar o diálogo, pressione ESC para cancelar o diálogo. " +
						"Quando um diálogo possui várias guias, a lista de guias pode ser acessada com ALT+F10 ou com TAB como parte da ordem de guias do diálogo. " +
						"Com o foco na lista de guias, mova para a guia seguinte e anterior com SETA PARA A DIREITA e SETA PARA A ESQUERDA, respectivamente."
				},
		...
		},
		{
			...
			[
				...
				},
				{
					...
					legend: 'Pressione ${ibmpermanentpen} (Alt+Cmd+T no MAC) dentro do editor para ativar/desativar a caneta permanente.'
				},
				{
