	...
	[
		{
			...
			[
				{
					name : "편집기 도구 모음",
					legend: "도구 모음으로 이동하려면 ${toolbarFocus}을(를) 누르십시오. " +
						"TAB 및 SHIFT+TAB을 사용하여 그 다음 및 이전 도구 모음 그룹으로 이동하십시오. " +
...

				{
					name: "편집기 대화 상자",
					legend:
						"대화 상자 내에서 TAB을 누르면 그 다음 대화 상자 요소로 이동할 수 있습니다. 이전 대화 상자 요소로 이동하려면 SHIFT+TAB을 누르고 대화 상자를 제출하려면 ENTER를 누르거나 대화 상자를 취소하려면 ESC를 누르십시오. " +
						"대화 상자에 여러 탭이 있으면 대화 상자 탭 순서의 파트로 TAB을 사용하거나 ALT+F10을 사용하여 탭 목록에 도달할 수 있습니다. " +
						"탭 목록에 초점을 맞춰 각각 오른쪽 및 왼쪽 화살표를 사용하여 그 다음 탭 및 이전 탭으로 이동하십시오."
				},
		...
		},
		{
			...
			[
				...
				{
					name: ' 글꼴 고정',
					legend: '편집기에서 ${ibmpermanentpen}(MAC의 경우, Alt+Cmd+T)을 눌러 글꼴 고정을 활성화/비활성화하십시오.'
				},
				{
					name : " 내게 필요한 옵션 도움말",
					legend : "${a11yHelp} 누르기"
