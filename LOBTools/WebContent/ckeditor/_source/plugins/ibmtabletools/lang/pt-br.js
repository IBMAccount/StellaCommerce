...
CKEDITOR.plugins.setLang( 'ibmtabletools', 'pt-br', {
	...
	sortTable : "Tabela de Classificação",
	sortTableContextMenuOption : "Tabela de Classificação",
	colNumber : "Coluna",
	...
	invalidColumnNumber	: "O número da coluna deve ser um número positivo.",
	columnDoesNotExist	: "A coluna $1 não existe.",
	mergedCells : 'Não é possível classificar uma tabela que contém células mescladas'
});
