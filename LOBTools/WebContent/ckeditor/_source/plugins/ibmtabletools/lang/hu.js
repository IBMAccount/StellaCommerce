...
CKEDITOR.plugins.setLang( 'ibmtabletools', 'hu', {
	...
	sortTableContextMenuOption : "Táblázat rendezése",
	colNumber : "Oszlop",
	...
	columnDoesNotExist	: "A(z) $1 oszlop nem létezik.",
	mergedCells : 'Összevont cellákat tartalmazó táblázatot nem lehet rendezni'
});
