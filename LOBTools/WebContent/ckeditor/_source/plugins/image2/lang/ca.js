...
CKEDITOR.plugins.setLang( 'image2', 'ca', {
	alt: 'Text alternatiu',
	btnUpload: 'Envia\'l a un servidor',
	captioned: 'Imatge amb llegenda',
	captionPlaceholder: 'Llegenda',
	infoTab: 'Informació de la imatge',
	lockRatio: 'Bloca la relació',
	menu: 'Propietats de la imatge',
	pathName: 'imatge',
	pathNameCaption: 'llegenda',
	resetSize: 'Restableix la mida',
	resizer: 'Feu clic i arrossegueu per canviar la mida',
