...
OnBehalfUtilities = function(){
	...
	this.cancelOrder = function(orderId, reloadURL){
		...
		wc.service.invoke("AjaxCancelOrderAdministrator", {'orderId' : orderId});
	};
...
wc.service.declare({
	...
	url: getAbsoluteURL() +  "AjaxRESTCSROrderCancelOnbehalf?forcedCancel=true",
	formId: ""
