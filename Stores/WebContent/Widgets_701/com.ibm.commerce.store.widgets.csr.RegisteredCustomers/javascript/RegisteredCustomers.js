...
RegisteredCustomers = function(){
	...
	*/
	...
	this.createGuestUser = function(landingURL){
		...
		if(authToken == null || authToken == '')
		{
			var customerNavigationForm = document.forms["customerServiceNavigationAction_AuthTokenInfo"];
			authToken = customerNavigationForm.customerServiceNavigationActions_authToken.value;
			renderContext.properties["authToken"] = authToken;
		}
	...
	this.setUserInSession = function(userId, selectedUser,landingURL){
		...
		if(authToken == null || authToken == '')
		{
			var findCustomersForm = document.forms["customerServiceNavigationAction_AuthTokenInfo"];
			authToken = findCustomersForm.customerServiceNavigationActions_authToken.value;
			renderContext.properties["authToken"] = authToken;
		}
